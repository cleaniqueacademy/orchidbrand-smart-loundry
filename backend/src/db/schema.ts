...
export const tenants = pgTable("tenants", {
  ...
  // Pengaturan Biaya & SOP Outlet Opsional
  customExpenseCategories: text("custom_expense_categories"), // JSON array string
  customSopRatios: text("custom_sop_ratios"), // JSON object string
  createdAt: text("created_at").notNull().$defaultFn(() => new Date().toISOString()),
});
...
export const expenses = pgTable("expenses", {
  ...
  rentDurationMonths: doublePrecision("rent_duration_months"), // null jika bukan beban sewa berjangka
  rentStartDate: text("rent_start_date"), // YYYY-MM-DD
  isAutoGenerated: text("is_auto_generated").notNull().default("false"), // 'true' jika auto-generated sistem
  createdAt: text("created_at").notNull().$defaultFn(() => new Date().toISOString()),
});
