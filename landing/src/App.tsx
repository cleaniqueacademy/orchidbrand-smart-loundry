...
export function App() {
  ...
  return <div className="site-shell">
    <header className="nav-wrap">
      <a className="brand" href="#top" aria-label="Laundry Cleanique home"><span className="brand-mark">c</span><span>cleanique<span className="brand-dot">.</span>laundry</span></a>
    ...
    <main id="top">
      <section className="hero section-pad">
        <div className="hero-copy">
          ...
          <p className="hero-lead">Laundry Cleanique menyatukan kasir, cucian, pelanggan, dan angka bisnis dalam satu ruang kerja yang tenang.</p>
        ...
        <div className="hero-visual" aria-label="Preview dashboard Laundry Cleanique">
      ...
      <section className="intro section-pad" id="cara-kerja"><div className="section-kicker">WHY Laundry Cleanique</div><div className="intro-grid"><h2>Yang rumit di belakang layar,<br /><em>terasa sederhana</em> di depan.</h2><div><p className="large-copy">Bisnis laundry tidak kekurangan kerja keras. Yang sering hilang adalah visibilitas—di antara nota, chat, rak, shift, dan laporan.</p><p className="body-copy">Laundry Cleanique memberi tim Anda satu sumber kebenaran, supaya setiap order bergerak tepat waktu dan setiap keputusan dibuat dari data yang nyata.</p></div></div></section>
