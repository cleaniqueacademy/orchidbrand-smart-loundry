      ...
      <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl border border-zinc-200 animate-in fade-in zoom-in-95 duration-100">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="font-bold text-zinc-900 text-base">Tambah Pengguna</h3>
              <p className="text-xs text-zinc-500">Buat akun pengguna baru</p>
            </div>
          </div>
          <button
            onClick={onClose}
            ...
            <>
              ...
              <div>
                ...
                <p className="text-[10px] text-zinc-400 mt-1">
                  Batas tanggal masa aktif akun login.
                </p>
              </div>
            </>
          )}
